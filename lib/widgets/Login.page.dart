...
class _LoginPageState extends State<LoginPage> {
  ...
  void onLoginSuccess(BuildContext context, String email, String password, String token) async {
  ...
  void _navigateToHomePage(BuildContext context, WidgetRef ref) async {
    ...
    if (response != null && response is Map<String, dynamic>) {
      ...
      String tokenStr = response.containsKey('token') ? response['token'].toString() : "";
      int userId = response.containsKey('userId') ? int.tryParse(response['userId'].toString()) ?? 0 : 0;
      String role = response.containsKey("role") ? response['role'].toString() : "user";
